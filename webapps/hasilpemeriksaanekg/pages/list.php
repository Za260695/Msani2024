    ...
    <div class="entry">        
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            <?php
                ...
                $no_rawat           = validTeks((isset($_GET['no_rawat'])?$_GET['no_rawat']:NULL),20);
            ...
            <?php
                ...
                if (isset($BtnSimpan)) {
                    $no_rawat   = validTeks(trim($_POST['no_rawat']),20);
                    ...
                    if((strtolower(substr($gambar,-3))=="jpg")||(strtolower(substr($gambar,-4))=="jpeg")){  
                        ...
                        if ((!empty($no_rawat))&&(!empty($gambar))) {
                            Tambah(" hasil_pemeriksaan_ekg_gambar "," '$no_rawat','$gambar'", " Gambar EKG " );
        ...
        <?php
            if ($action=="HAPUS") {
                unlink($_GET['gambar']);
                Hapus(" hasil_pemeriksaan_ekg_gambar "," no_rawat ='".validTeks($_GET['no_rawat'],20)."'","?act=List&action=TAMBAH&no_rawat=$no_rawat");
            }
