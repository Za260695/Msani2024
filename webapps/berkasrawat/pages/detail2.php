		...
		<tr class="isi2">
            ...
            <?php
                ...
                if (isset($BtnSimpan)) {
                    ...
                    $no_rawat_tanpa_slash = str_replace('/', '-',$norawat);
                    $kode               = validTeks(trim($_POST['kode']));
                    $dokumen            = validTeks(str_replace(" ","_","pages/upload/".$tgl_registrasi."_".$no_rkm_medis."_".$nm_pasien.$kode."_"."_".$_FILES['dokumen']['name']));
