                    ...
                    try {
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                datajam=Sequel.cariIsi("SELECT concat(antriloketcetak.tanggal,' ',antriloketcetak.jam) FROM antriloketcetak INNER JOIN reg_periksa ON antriloketcetak.no_rkm_medis = reg_periksa.no_rkm_medis AND antriloketcetak.tanggal = reg_periksa.tgl_registrasi WHERE reg_periksa.no_rawat =?",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                ...
                                datajam=Sequel.cariIsi("SELECT concat(antriloketcetak.tanggal,' ',antriloketcetak.jampanggil) FROM antriloketcetak INNER JOIN reg_periksa ON antriloketcetak.no_rkm_medis = reg_periksa.no_rkm_medis AND antriloketcetak.tanggal = reg_periksa.tgl_registrasi WHERE reg_periksa.no_rawat =?",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
